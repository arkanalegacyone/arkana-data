...
(async function(){
  ...
  // Updated PAGE 4 (Flaws) rendering/wiring
  ...
  // PAGE 5, 6, and render function unchanged (use previous working versions)
  ...
  function page5_render(){
    ...
    var html =
      ...
      '<div class="note">Select any combination of powers, perks, archetype powers, cybernetics, magic school weaves, and cybernetic slots. You cannot spend more points than you have.</div>' +
